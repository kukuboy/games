    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gradient mb-2">欢迎回来</h1>
          <p className="text-gray-400">登录到游戏中心</p>
        </div>
        ...
        <div className="mt-6 p-4 rounded-lg glass-card border border-white/10">
          <p className="text-sm text-gray-400 text-center mb-2">测试账号（演示用）：</p>
          <div className="text-xs text-gray-500 space-y-1">
            <p>邮箱：player1@game.com</p>
            <p>密码：demo123</p>
          </div>
        </div>
      </div>
